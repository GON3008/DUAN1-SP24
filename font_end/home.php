...
<section id="call-to-action"style="background-color: #F1EFEF;">
    <div class="container">
        <div class="call-to-action-content">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 m-auto">
                    <div class="single-action-item d-flex align-items-center">
                        <div class="call-action-icon">
                            <i style="color: #86B6F6" class="fa fa-truck"></i>
                        </div>
                        <div class="call-action-info">
                            <h4>Miễn phí vận chuyển</h4>
                            <p style="color: #86B6F6">trên đơn hàng trên 10tr</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-action-item d-flex align-items-center">
                        <div class="call-action-icon">
                            <i style="color: #6895D2" class="fa fa-support"></i>
                        </div>
                        <div class="call-action-info">
                            <h4>Hỗ trợ 24/7</h4>
                            <p style="color: #86B6F6">Tư vấn trực tuyến</p>
                        </div>
                    </div>
                </div>
                <!-- Single Call to Action End -->
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-action-item d-flex align-items-center">
                        <div class="call-action-icon">
                            <i style="color: #6895D2" class="fa fa-calendar"></i>
                        </div>
                        <div class="call-action-info">
                            <h4>cập nhật hàng ngày</h4>
                            <p style="color: #86B6F6">Kiểm tra cửa hàng</p>
                        </div>
                    </div>
                </div>
                <!-- Single Call to Action End -->
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-action-item d-flex align-items-center">
                        <div class="call-action-icon">
                            <i style="color: #6895D2" class="fa fa-refresh"></i>
                        </div>
                        <div class="call-action-info">
                            <h4>Đổi trả trong 30 ngày</h4>
                            <p style="color: #86B6F6">đảm bảo hoàn tiền</p>
                        </div>
                    </div>
                </div>
                <!-- Single Call to Action End -->
