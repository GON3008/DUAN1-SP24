                                    ...
                                    <div class="myaccount-content">
                                        ...
                                        if (isset($_SESSION['user'])) {
                                            ...
                                            if ($role == 1) {
                                                ...
                                                echo '(If Not <strong>Tuntuni !</strong><a href="login-register.html" class="logout"> Logout</a>)';
                                            }

                                            echo '</p></div>';
                                        } else {
                                            echo '<div class="welcome">';
                                            echo '<p>Hello, <strong>Bạn</strong> (If Not <strong>Tuntuni !</strong><a href="login-register.html" class="logout"> Logout</a>)</p>';
                                            echo '</div>';
                                        }
                                        ?>
