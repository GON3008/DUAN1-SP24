            ...
            <div class="col-lg-12">
                <div class="page-breadcrumb">
                    <ul class="nav">
                        ...
                        <li><a href="#" class="active"><?= $name_sp ?></a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-lg-7">
                            <div class="product-details">
                                ...
                                <form action="index.php?act=cart" method="post">
                                                   ...
                                                   <div class="py-4">
                                                   <input class="form-control" type="number" id="quantity" name="soluong" value="1" min="1" style="width: 150px; height: 40px" placeholder="Số lượng">
                                                   </div>
                                                   <div class="product-quantity d-flex align-items-center">
                                                

                                <input type="submit" class="add-to-cart-btn" value="Thêm vào giỏ hàng" name="add_to_cart" style="    background-color: #73b320;
                                    border: none;
                                    color: #fff;
                                    font-weight: 600;
                                    line-height: 1.2;
