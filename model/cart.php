    ...
    ,                $ngaydathang, $vnp_Amount, $vnp_BankCode, $vnp_BankTranNo, $vnp_CardType, $vnp_OrderInfo, $vnp_PayDate, $vnp_TmnCode, $vnp_TransactionNo, $code_order)
{
    ...
    $sql = "insert into bill(iduser,name_bill,email_bill,address_bill,tel_bill,ordernote_bill,tongtien_bill,pttt_bill,ngaydathang
,vnp_Amount,vnp_BankCode,vnp_BankTranNo,vnp_CardType,vnp_OrderInfo,vnp_PayDate,vnp_TmnCode,vnp_TransactionNo,code_order) values('$id_user','$name_bill','$email_bill','$address_bill','$tel_bill','$ordernote_bill' 
        ,'$tongtien_bill' ,'$pttt_bill','$ngaydathang','$vnp_Amount','$vnp_BankCode','$vnp_BankTranNo','$vnp_CardType','$vnp_OrderInfo','$vnp_PayDate','$vnp_TmnCode','$vnp_TransactionNo','$code_order')";
...
function get_payment($pttt_bill)
{
    $payment = "";  // Initialize the variable
